        ...
        <div className='fixed top-0 left-0 w-11/12 -z-10 translate-y-[-80%]'>
            ...
            flex items-center justify-between z-50 ${isScroll ? "bg-white bg-opacity-50 backdrop-blur-lg shadow-sm" : ""}`}>
                ...
                rounded-full px-12 py-3 ${isScroll ? "" : "bg-white shadow-sm bg-opacity-50"}`}>
                    ...
                    <li>
                        <a className='font-Ovo' href="#services">My Work</a>
                    </li>
                    <li>
                        <a className='font-Ovo' href="#work">Relevant Coursework</a>
                    </li>
                    <li>
                ...
                <div className='flex items-center gap-4'>
                    ...
                    <a href="#contact" className='hidden lg:flex items-center gap-3 px-10 py-2.5 border border-gray-500 rounded-full m1-4 font-Ovo'>Contact <Image src={assets.arrow_icon} className='w-3'/></a>
